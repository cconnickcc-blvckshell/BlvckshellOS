...
class AuditEventType(str, Enum):
    ...
    JUDGMENT_STAGE_COMPLETED = "JUDGMENT_STAGE_COMPLETED"
    JUDGMENT_GUARD_BLOCKED = "JUDGMENT_GUARD_BLOCKED"
    OUTCOME_RECORDED = "OUTCOME_RECORDED"
    BELIEF_UPDATED = "BELIEF_UPDATED"
    DOCTRINE_FLAGGED = "DOCTRINE_FLAGGED"
    DOCTRINE_CONFIDENCE_REDUCED = "DOCTRINE_CONFIDENCE_REDUCED"
    ...
    OPINION_REVISED = "OPINION_REVISED"
    REFLECTION_COMPLETED = "REFLECTION_COMPLETED"
    AGENT_LOOP_REPLANNED = "AGENT_LOOP_REPLANNED"
    ERROR = "ERROR"
